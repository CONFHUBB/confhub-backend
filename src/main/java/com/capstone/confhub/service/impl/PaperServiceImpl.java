...
public class PaperServiceImpl implements PaperService {
    ...
    private static final Map<PaperStatus, Set<PaperStatus>> VALID_TRANSITIONS = Map.ofEntries(
            ...
            Map.entry(PaperStatus.ACCEPTED, Set.of(PaperStatus.AWAITING_REGISTRATION, PaperStatus.AWAITING_CAMERA_READY, PaperStatus.WITHDRAWN)),
            Map.entry(PaperStatus.REJECTED, Set.of()),
            Map.entry(PaperStatus.AWAITING_REGISTRATION, Set.of(PaperStatus.REGISTERED, PaperStatus.AWAITING_CAMERA_READY)),
