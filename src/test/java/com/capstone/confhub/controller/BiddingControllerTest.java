...
class BiddingControllerTest {
    ...
    void submitOrUpdateBidShouldReturnOk() {
        ...
        var response = mock(com.capstone.confhub.dto.response.BiddingResponseDTO.class);
    ...
    void getPapersForBiddingShouldReturnOk() {
        var payload = List.of(mock(com.capstone.confhub.dto.response.PaperForBiddingDTO.class));
    ...
    void getBidsByReviewerAndConferenceShouldReturnOk() {
        var payload = List.of(mock(com.capstone.confhub.dto.response.BiddingResponseDTO.class));
    ...
    void getBidsSummaryShouldReturnOk() {
        var payload = mock(com.capstone.confhub.dto.response.BidsSummaryDTO.class);
